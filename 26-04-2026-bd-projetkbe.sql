...
(12, 'Je suis une lame invisible faite de vent rapide. Qui suis-je ?', 'Wind Slash', 'Ice Spike', 'Lightning Bolt', 'Tempête des Sept Éclairs', 'Cherche un sort rapide associé à l'air.', 'Moyenne', 1, 0, 10, 0, 1),
(13, 'Je tombe du ciel avec une force électrique redoutable. Qui suis-je ?', 'Lightning Bolt', 'Earthquake', 'Fireball', 'Holy Light', 'Va dans les sorts de foudre.', 'Difficile', 1, 10, 0, 0, 1),
(14, 'Je fais trembler le sol sous les pieds de tous. Qui suis-je ?', 'Earthquake', 'Lightning Bolt', 'Wind Slash', 'Ice Spike', 'Cherche un sort qui frappe la terre entière.', 'Difficile', 1, 10, 0, 0, 1),
(15, 'Je rends un peu de vie après un combat. Qui suis-je ?', 'Small Health Potion', 'Antidote', 'Medium Health Potion', 'Mana Potion', 'Va voir les petites potions de soin.', 'Facile', 2, 0, 0, 10, 1),
(16, 'Je retire le poison du corps de celui qui me boit. Qui suis-je ?', 'Antidote', 'Small Health Potion', 'Medium Health Potion', 'Strength Potion', 'Cherche une potion contre un mauvais effet.', 'Facile', 2, 0, 0, 10, 1),
(17, 'Je rends une quantité moyenne de vie au joueur. Qui suis-je ?', 'Medium Health Potion', 'Small Health Potion', 'Mana Potion', 'Strength Potion', 'Va voir les potions de soin intermédiaires.', 'Moyenne', 2, 0, 10, 0, 1),
(18, 'Je rends du mana pour continuer à lancer des sorts. Qui suis-je ?', 'Mana Potion', 'Medium Health Potion', 'Strength Potion', 'Mega Mana Potion', 'Cherche une potion liée à la magie.', 'Moyenne', 2, 0, 10, 0, 1),
(19, 'Je donne plus de force pendant un moment. Qui suis-je ?', 'Strength Potion', 'Mana Potion', 'Mega Mana Potion', 'Medium Health Potion', 'Va voir les potions qui améliorent les statistiques.', 'Difficile', 2, 10, 0, 0, 1),
(20, 'Je rends énormément de mana à celui qui me boit. Qui suis-je ?', 'Mega Mana Potion', 'Strength Potion', 'Mana Potion', 'Medium Health Potion', 'Cherche la version la plus puissante d'une potion magique.', 'Difficile', 2, 10, 0, 0, 1),
(21, 'Je suis une épée simple pensée pour débuter. Qui suis-je ?', 'Basic Sword', 'Dagger', 'Knight Blade', 'Hunter Bow', 'Regarde les armes les plus de base.', 'Facile', 3, 0, 0, 10, 1),
(22, 'Je suis une petite lame légère et rapide. Qui suis-je ?', 'Dagger', 'Basic Sword', 'Knight Blade', 'War Axe', 'Cherche une arme courte et discrète.', 'Facile', 3, 0, 0, 10, 1),
(23, 'Je suis une épée robuste portée par les chevaliers. Qui suis-je ?', 'Knight Blade', 'Basic Sword', 'Dagger', 'Dragon Slayer', 'Va voir les armes de chevalier.', 'Moyenne', 3, 0, 10, 0, 1),
(24, 'Je suis une arme précise pour attaquer à distance. Qui suis-je ?', 'Hunter Bow', 'Knight Blade', 'War Axe', 'Dragon Slayer', 'Cherche une arme qui lance des projectiles.', 'Moyenne', 3, 0, 10, 0, 1),
(25, 'Je suis une hache lourde faite pour frapper fort. Qui suis-je ?', 'War Axe', 'Hunter Bow', 'Dragon Slayer', 'Knight Blade', 'Va voir les armes les plus massives.', 'Difficile', 3, 10, 0, 0, 1),
(26, 'Je suis une grande épée créée pour tuer les monstres. Qui suis-je ?', 'Dragon Slayer', 'War Axe', 'Hunter Bow', 'Knight Blade', 'Cherche une arme légendaire très puissante.', 'Difficile', 3, 10, 0, 0, 1),
(27, 'Je suis une armure légère en cuir. Qui suis-je ?', 'Leather Armor', 'Traveler Vest', 'Chainmail', 'Mage Robe', 'Regarde les protections les plus simples.', 'Facile', 4, 0, 0, 10, 1),
(28, 'Je suis une veste légère portée par les aventuriers. Qui suis-je ?', 'Traveler Vest', 'Leather Armor', 'Chainmail', 'Shadow Cloak', 'Cherche une protection modeste de voyage.', 'Facile', 4, 0, 0, 10, 1),
(29, 'Je suis une armure faite de mailles de métal. Qui suis-je ?', 'Chainmail', 'Leather Armor', 'Traveler Vest', 'Dragon Scale Armor', 'Va voir les armures intermédiaires.', 'Moyenne', 4, 0, 10, 0, 1),
(30, 'Je suis une robe conçue pour ceux qui utilisent la magie. Qui suis-je ?', 'Mage Robe', 'Chainmail', 'Shadow Cloak', 'Dragon Scale Armor', 'Cherche une tenue liée aux mages.', 'Moyenne', 4, 0, 10, 0, 1),
(31, 'Je suis une cape sombre qui protège avec discrétion. Qui suis-je ?', 'Shadow Cloak', 'Mage Robe', 'Dragon Scale Armor', 'Chainmail', 'Va voir les protections furtives.', 'Difficile', 4, 10, 0, 0, 1),
(32, 'Je suis une armure forgée à partir d'écailles rares. Qui suis-je ?', 'Dragon Scale Armor', 'Shadow Cloak', 'Mage Robe', 'Chainmail', 'Cherche l'une des protections les plus puissantes.', 'Difficile', 4, 10, 0, 0, 1),
(33, 'Je suis un peuple du nord connu pour mes drakkars, mes raids et mes guerriers redoutés. Qui suis-je ?', 'Vikings', 'France', 'Croisés', 'Mongols', 'Peuple scandinave célèbre du Moyen Âge.', 'Facile', 5, 0, 0, 10, 1),
(34, 'Je suis un grand royaume médiéval souvent associé aux rois, aux châteaux et aux chevaliers. Qui suis-je ?', 'France', 'Vikings', 'Croisés', 'Constantinople', 'Un royaume très puissant en Europe médiévale.', 'Facile', 5, 0, 0, 10, 1),
(35, 'Nous sommes des chevaliers chrétiens partis combattre en Terre sainte. Qui sommes-nous ?', 'Croisés', 'Vikings', 'Constantinople', 'Mongols', 'Ils participaient aux croisades.', 'Moyenne', 5, 0, 10, 0, 1),
(36, 'Je suis une grande ville souvent vue comme le cœur de l'Empire byzantin. Qui suis-je ?', 'Constantinople', 'France', 'Croisés', 'Espagne', 'Aujourd'hui, cette ville porte un autre nom.', 'Moyenne', 5, 0, 10, 0, 1),
(37, 'Je suis un peuple cavalier venu d'Asie qui a bâti un immense empire sous Gengis Khan. Qui suis-je ?', 'Mongols', 'Vikings', 'Croisés', 'Espagne', 'Empire nomade très vaste.', 'Difficile', 5, 10, 0, 0, 1),
(38, 'Je suis un royaume chrétien de la péninsule ibérique lié à la Reconquista. Qui suis-je ?', 'Espagne', 'Mongols', 'Constantinople', 'France', 'Pense à la Reconquista.', 'Difficile', 5, 10, 0, 0, 1);
